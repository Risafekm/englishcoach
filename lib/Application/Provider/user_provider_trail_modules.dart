...
// get count
  ...
  //     // Verify that the data is a map with integer keys
  //     if (data is Map<int, dynamic>) {
  //       return data;
  //     } else {
  //       throw FormatException('Unexpected format of count data');
  //     }
  //   } catch (e) {
  //     print('Error fetching count: $e');
  //     // Handle the error gracefully, e.g., return a default value or rethrow the error
  //     throw e;
  //   }
  // }
